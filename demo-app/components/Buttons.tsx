...
export const ButtonToday: NextComponentType = () => {
	...
	return (
		<button
			type="button"
			className="w-1/2 px-5 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg dark:bg-blue-600 hover:bg-blue-800 dark:hover:bg-blue-700 focus:ring-4 focus:ring-blue-300"
			onClick={() => {
...
export const ButtonClear: NextComponentType = () => {
	...
	return (
		<button
			type="button"
			className="w-1/2 px-5 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg dark:text-white dark:bg-gray-700 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-600 focus:ring-4 focus:ring-blue-300"
