...
var DatePickerContext = react.exports.createContext({
    view: "days",
    setView: function () { },
...
var DatePickerProvider = function (_a) {
    ...
    var _b = react.exports.useState("days"), view = _b[0], setView = _b[1];
    var _c = react.exports.useState(false), datePickerShow = _c[0], setShowDatePicker = _c[1];
    var _d = react.exports.useState(new Date()), selectedDate = _d[0], setSelectedDate = _d[1];
    var _e = react.exports.useState(true), showSelectedDate = _e[0], setShowSelectedDate = _e[1];
...
var ButtonPrevMonth = function () {
    var _a = react.exports.useContext(DatePickerContext), selectedDate = _a.selectedDate, setSelectedDate = _a.setSelectedDate, view = _a.view;
...
var ButtonSelectMonth = function () {
    var _a = react.exports.useContext(DatePickerContext), selectedDate = _a.selectedDate, view = _a.view, setView = _a.setView;
...
var ButtonToday = function () {
    var _a = react.exports.useContext(DatePickerContext), setSelectedDate = _a.setSelectedDate, setShowSelectedDate = _a.setShowSelectedDate, setView = _a.setView;
...
var ButtonClear = function () {
    var setShowSelectedDate = react.exports.useContext(DatePickerContext).setShowSelectedDate;
...
var Days = function (_a) {
    ...
    var _b = react.exports.useContext(DatePickerContext), selectedDate = _b.selectedDate, setSelectedDate = _b.setSelectedDate, showSelectedDate = _b.showSelectedDate, setShowSelectedDate = _b.setShowSelectedDate;
...
var Decades = function () {
    var _a = react.exports.useContext(DatePickerContext), selectedDate = _a.selectedDate, showSelectedDate = _a.showSelectedDate, setSelectedDate = _a.setSelectedDate, setView = _a.setView, setShowSelectedDate = _a.setShowSelectedDate;
...
var Months = function () {
    var _a = react.exports.useContext(DatePickerContext), selectedDate = _a.selectedDate, showSelectedDate = _a.showSelectedDate, setSelectedDate = _a.setSelectedDate, setShowSelectedDate = _a.setShowSelectedDate, setView = _a.setView;
...
var DatePickerPopup = react.exports.forwardRef(function (_a, ref) {
    var title = _a.title, actionButtons = _a.actionButtons;
    var _b = react.exports.useContext(DatePickerContext), selectedMonth = _b.selectedMonth, selectedYear = _b.selectedYear, view = _b.view;
...
var DatePickerMain = function (_a) {
    var title = _a.title, actionButtons = _a.actionButtons;
    var setShowDatePicker = react.exports.useContext(DatePickerContext).setShowDatePicker;
    var datePickerShow = react.exports.useContext(DatePickerContext).datePickerShow;
    var InputRef = react.exports.useRef(null);
    var DatePickerRef = react.exports.useRef(null);
...
var Input = react.exports.forwardRef(function (_props, ref) {
    var _a = react.exports.useContext(DatePickerContext), setShowDatePicker = _a.setShowDatePicker, selectedDate = _a.selectedDate, showSelectedDate = _a.showSelectedDate;
